...
export default function ConfessionsViewAllModal({
  confessions,
  completedToday,
  completing,
  onClose,
    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
      <div className="bg-white rounded-t-2xl sm:rounded-2xl w-full sm:max-w-lg max-h-[92vh] flex flex-col shadow-2xl">
        ...
        <div className="flex items-start justify-between px-6 py-5 border-b border-gray-100 shrink-0">
          <div>
            <h2 className="text-xl font-bold tracking-tight">My Daily Confessions</h2>
        ...
        <div className="px-6 py-5 border-t border-gray-100 shrink-0 space-y-3">
          ...
          >
            <Check size={16} />
            {completedToday ? "Confessions Completed Today" : "I Confessed These Today"}
          </button>
          <button
            onClick={onEdit}
